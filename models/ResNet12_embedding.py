...
class ResNet(nn.Module):
    ...
    def __init__(self, block, keep_prob=1.0, avg_pool=False, drop_rate=0.0, dropblock_size=5):
        ...
        self.layer1 = self._make_layer(block, 32, stride=2, drop_rate=drop_rate)
        self.layer2 = self._make_layer(block, 48, stride=2, drop_rate=drop_rate)
        self.layer3 = self._make_layer(block, 64, stride=2, drop_rate=drop_rate, drop_block=True, block_size=dropblock_size)
        self.layer4 = self._make_layer(block, 128, stride=2, drop_rate=drop_rate, drop_block=True, block_size=dropblock_size)
        if avg_pool:
